...
public class UpdateEventRequest {
    ...
    public UpdateEventRequest(String name, String description, Integer maxParticipants, PrivacyType privacyType, Long eventTypeId, CreateLocationRequest location, LocalDate startDate, LocalDate endDate, List<CreateActivityRequest> activities, String imageBase64) {
        this.name = name;
